  ...
  return (
    <div className={classes.container}>
      <div className={classes.content}>
        <TitleImage title="MES CENTRES D’INTÉRÊT" color="#420FAB" size={32} backgroudColor="#fff" className={classes.tContainer} />
        ...
        <div className={classes.subTitleContainer}>
          <div className={classes.subTitle}>
            ...
            <div className={classes.line1}>
              <b>À toi de choisir ceux qui te plairaient le plus
              {'  '}
